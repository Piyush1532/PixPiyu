...
const togglePublish=async () => {
  ...
  return (
    <tr className='border-y border-gray-300'>
      ...
      <td className='px-2 py-4 text-pretty'>{title}</td>
      ...
      <td className='px-2 py-4 flex text-xs gap-3'>
        <button className='border px-2 py-0.5 mt-1 rounded cursor-pointer' onClick={togglePublish}>{blog.isPublished ? "Unpublished":"Published"}</button>
